...
pub struct DungeonLightsPlugin;

impl Plugin for DungeonLightsPlugin {
...
struct CustomMaterial {
    #[uniform(0)]
    character_position_x: f32,
    #[uniform(1)]
    character_position_y: f32,
    #[uniform(2)]
    light_source_positions: [Vec4; 2],
    #[texture(3)]
    #[sampler(4)]
...
impl Material for CustomMaterial {
    fn vertex_shader() -> ShaderRef {
        "shaders/18_dungeon_lights.wgsl".into()
    }
        ...
        match message {
            DevUIControlMessage::CharacterPositionXChanged(character_position_x) => {
                if let Some(material) = materials.get_mut(&material.0) {
                    material.character_position_x = *character_position_x;
                }
            }
            DevUIControlMessage::CharacterPositionYChanged(character_position_y) => {
                if let Some(material) = materials.get_mut(&material.0) {
                    material.character_position_y = *character_position_y;
                }
            }
        }
    }
